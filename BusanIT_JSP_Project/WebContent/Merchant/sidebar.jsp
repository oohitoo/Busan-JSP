...
<ul
	...
	<li class="nav-item active">
		<a class="nav-link" href="shopPaidList.jsp"> 
			<span>결재 완료</span>
		</a>
	</li>
	<li class="nav-item active">
		<a class="nav-link" href="shopDeliveredList.jsp"> 
			<span>배달 완료</span>
		</a>
	</li>
	<li class="nav-item active">
		<a class="nav-link" href="shopReservationList.jsp">
			<span>예약</span>
		</a>
	</li>
	<li class="nav-item active">
		<a class="nav-link" href="shopServedList.jsp"> 
			<span>완료</span>
		</a>
	</li>
	...
	<li class="nav-item active">
		<a class="nav-link" href="reviewshop.jsp"> 
			<span>댓글 관리</span>
		</a>
	</li>
	<li class="nav-item active">
